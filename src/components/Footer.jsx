  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-700">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-4">
              {/* SSL Security Badge */}
              <div className="bg-green-600 rounded-lg p-3 flex items-center space-x-3">
          ...
          <div className="flex justify-center lg:justify-end space-x-6">
            ...
            <div className="w-16 h-16 bg-slate-800 rounded-lg flex items-center justify-center border border-slate-700">
              <span className="text-gray-400 text-xs font-bold">GamCare</span>
            </div>
            
            {/* 18+ Logo */}
            <div className="w-16 h-16 bg-slate-800 rounded-lg flex items-center justify-center border border-slate-700">
              <span className="text-gray-400 text-2xl font-bold">18+</span>
            </div>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="mt-6 pt-4 border-t border-slate-700 flex flex-col md:flex-row justify-between items-center">
